...
- (id)init {
    if (self = [super init]) {
        ...
        for(int i=0;i<10;i++) {
//            TTTableItem *tableItem = [TTTableSubtitleItem itemWithText:(NSString *)text subtitle:<#(NSString *)subtitle#> imageURL:<#(NSString *)imageURL#> defaultImage:<#(UIImage *)defaultImage#> URL:<#(NSString *)URL#> accessoryURL:<#(NSString *)accessoryURL#>];
